...
Chainable tools for iOS API, code is Generated by Sourcery.
  ...
  s.subspec 'Core' do |cs|
    cs.source_files = 'EGChainable/Classes/Chainable.swift'
  end

  s.subspec 'Common' do |cs|
    cs.source_files = 'EGChainable/Classes/Generated/Common/**/*.swift'
    cs.dependency 'EGChainable/Core'
  end

  s.subspec 'Other' do |cs|
    cs.source_files = 'EGChainable/Classes/Generated/Other/**/*.swift'
    cs.dependency 'EGChainable/Core'
  end
